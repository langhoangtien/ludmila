...
const en = {
  notification: {
    ...
    update: { success: 'Cập nhật thành công', error: 'Cập nhật thất bại' },
    delete: { success: 'Xóa thành công', error: 'Xóa thất bại' },
    create: { success: 'Tạo mới thành công', error: 'Tạo mới thất bại' },
  },
  demo: {
    title: `English`,
